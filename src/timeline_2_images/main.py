...
{deep_purple}║{reset}                                                                 {deep_purple}║{reset}
{deep_purple}║{reset}    {white}███████{reset}{dark_grey}╗{reset}  {lilac}██{reset}{deep_purple}╗{reset}{lilac}███{reset}{deep_purple}╗{reset}   {lilac}███{reset}{deep_purple}╗{reset} {lilac}█████{reset}{deep_purple}╗{reset}  {lilac}██████{reset}{deep_purple}╗{reset} {lilac}███████{reset}{deep_purple}╗{reset}{lilac}███████{reset}{deep_purple}║{reset}    {deep_purple}║{reset}
